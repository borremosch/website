  ...
  return (
    <Paper className={styles['page']}>
      <div className={styles['page-content']}>
        ...
        <Typography variant="body1">
          Questions and other comments sent to us by e-mail are saved for future reference, but only for the purpose of
          improving future correspondence.
        </Typography>

        <Typography variant="h1">Questions</Typography>

        <Typography variant="body1">
          Should you have any questions regarding this privacy statement, or any other inquiries, please do not hesitate
