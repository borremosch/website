    ...
    <Paper className={styles['manual']}>
      ...
      <div className={styles['screen-overview-container']}>
        ...
        <div className={styles['screen-overview']}>
          ...
          <div className={styles['legend']} style={{ left: '6.6%', top: '4.5%', height: '14.5%' }}>
            <Link href="#screenoverview_mode_dropdown" className={styles['legend-label']}>
              Mode dropdown
            </Link>
          </div>
          <div className={styles['legend']} style={{ left: '27%', top: '6%', height: '10%' }}>
            <Link href="#screenoverview_help" className={styles['legend-label']}>
              Help
            </Link>
          </div>
          <div className={styles['legend']} style={{ left: '72.2%', top: '4.5%', height: '8.5%' }}>
            <Link href="#screenoverview_function_dropdown" className={styles['legend-label']}>
              Function dropdown
            </Link>
          </div>
          <div className={styles['legend']} style={{ left: '84.4%', top: '4.5%', height: '5.5%' }}>
            <Link href="#screenoverview_output_dropdown" className={styles['legend-label']}>
              Output dropdown
            </Link>
          </div>
          <div className={styles['legend']} style={{ left: '94.7%', top: '4.5%', height: '2.5%' }}>
          ...
          <div className={styles['legend']} style={{ left: '50%', top: '30%' }}>
          ...
          <div
            ...
            style={{ left: '8.2%', top: '38.7%', height: '8.5%' }}
          >
          ...
          <div
            className={`${styles['legend']} ${styles['legend-top']}`}
            style={{ left: '24.7%', top: '41.7%', height: '5.5%' }}
          >
          ...
          <div
            className={`${styles['legend']} ${styles['legend-top']}`}
            style={{ left: '49.85%', top: '44.7%', height: '2.5%' }}
          >
          ...
          <div className={`${styles['legend']} ${styles['legend-horizontal']}`} style={{ left: '59%', top: '54%' }}>
      ...
      <div className={styles['example']}>
        <div className={styles['description']}>Example: correct usage of the negate and subtract operators</div>
        <div className={styles['screen']}>
          <div className={styles['input']}>10 &minus; 5</div>
          <div className={styles['output']}>5</div>
          <div className={styles['input']}>5 × -5</div>
          <div className={styles['output']}>-25</div>
        </div>
      </div>
      ...
      <p className={styles['example']}>
        <span className={styles['description']}>Example: incorrect usage of the negate and subtract operators</span>
        <div className={styles['screen']}>
          <span className={styles['input']}>10-5</span>
          <span className={styles['output']}>-50</span>
          <span className={styles['input']}>5 × &minus; 5</span>
          <span className={`${styles['output']} ${styles['error']}`}>Value expected</span>
        </div>
      </p>
      ...
      <p className={styles['example']}>
        <span className={styles['description']}>Example: complex number calculations</span>
        <div className={styles['screen']}>
          <span className={styles['input']}>2 + 4i / 2</span>
          <span className={styles['output']}>2 + 2i</span>
          <span className={styles['input']}>(2 + 4i) / 2</span>
          <span className={styles['output']}>1 + 2i</span>
        </div>
      </p>
      ...
      <p className={styles['example']}>
        <span className={styles['description']}>Example: using the 'Ans' variable</span>
        <div className={styles['screen']}>
          <span className={styles['input']}>5 × 10</span>
          <span className={styles['output']}>50</span>
          <span className={styles['input']}>Ans / 2</span>
          <span className={styles['output']}>25</span>
        </div>
      </p>
      ...
      <Typography variant="body1" paragraph={true}>
        ...
        <p className={styles['example']}>
          <span className={styles['description']}>Example: using variables</span>
          <div className={styles['screen']}>
            <span className={styles['input']}>
              5 × 3 &rarr; <strong>a</strong>
            </span>
            <span className={styles['output']}>15</span>
            <span className={styles['input']}>
              2 × 7 &rarr; <strong>a</strong>
            </span>
            <span className={styles['output']}>14</span>
            <span className={styles['input']}>
              <strong>a</strong> + <strong>b</strong>
            </span>
            <span className={styles['output']}>29</span>
          </div>
        </p>
        ...
        <Typography variant="body1" paragraph={true}>
          MathsApp also contains a list type, which has the notation {'{'}1, 2, ...{'}'}. A list may contain any number
          of complex numbers, but no other lists or matrices. To enter a list, press the{' '}
          <span className={`${styles['button']} ${styles['button-function']}`}>
            {'{'}L{'}'}
          </span>{' '}
        ...
        <p className={styles['example']}>
          <span className={styles['description']}>Example: operator overloading on lists</span>
          <div className={styles['screen']}>
            <span className={styles['input']}>
              {'{'}1, 2, 3{'}'} × 2
            </span>
...
<Typography variant="body1" paragraph={true}>This section contains an example showing you how you can use MathsApp as efficiently as possible. This example especially shows the power of operator overloading using lists.</p>

<Typography variant="h3">Question</Typography>

<Typography variant="body1" paragraph={true}>A cell tower in a communication network has to process two phone calls per minute on average. The call duration has a gamma distribution with an average of 1 minute. The cell tower is able to process at most four calls simultaneously. What is the probability that a phone call will be blocked because the cell tower is overloaded?</p>

<Typography variant="h3">Solution</Typography>

<Typography variant="body1" paragraph={true}>To answer this question, one may use the Erlang blocking formula:</p>

<img className="formula" src="/Content/Images/erlangb.png" />

<Typography variant="body1" paragraph={true}>Where:</p>
...
<Typography variant="body1" paragraph={true}>To calculate the answer to this problem with MathsApp, we first store the values to the appropriate variables:</p>

<p className={styles['example']}>
	<span className={styles['input']}>2 &rarr; <strong>l</strong></span>
  <div className={styles['screen']}>
    <span className={styles['output']}>2</span>
    <span className={styles['input']}>1 &rarr; <strong>b</strong></span>
    <span className={styles['output']}>1</span>
    <span className={styles['input']}>4 &rarr; <strong>k</strong></span>
    <span className={styles['output']}>4</span>
  </div>
</p>

<Typography variant="body1" paragraph={true}>Since i in this formula will take on the values {0, 1, ..., k-1, k}, we will store this list of values in i:</p>

<p className={styles['example']}>
  <div className={styles['screen']}>
    <span className={styles['input']}>range(0, <strong>k</strong>) &rarr; i</span>
    <span className={styles['output']}>{0, 1, 2, 3, 4}</span>
  </div>
</p>

<Typography variant="body1" paragraph={true}>Now we can easily calculate the answer:</p>

<p className={styles['example']}>
  <div className={styles['screen']}>
    <span className={styles['input']}>(<strong>lb</strong>)^<strong>k</strong> / <strong>k</strong>! / &Sigma;((<strong>lb</strong>)^<strong>i</strong> / <strong>i</strong>!)</span>
    <span className={styles['output']}>0.095238095</span>
  </div>
</p>

  <Typography variant="body1" paragraph={true}>So, the call blocking probability is 9.5%.</p>*/}
      </Typography>
    </Paper>
  );
}
